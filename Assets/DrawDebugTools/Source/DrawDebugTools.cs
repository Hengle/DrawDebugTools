...
public class DrawDebugTools : MonoBehaviour
{
    ...
    private static DrawDebugTextManager m_DrawDebugTextManager;
    ...
    {
        InitializeMaterials();
        m_DrawDebugTextManager = new DrawDebugTextManager();
    }
    ...
    public static void DrawDebugString( Vector3  TextLocation, string Text, Color  TextColor, float Duration = -1.0f, bool  DrawShadow = false)
    {
        m_DrawDebugTextManager.AddNewText(new DrawDebugText("Hello world", TextAnchor.MiddleLeft, new Vector3(20.0f, 20.0f), 0.0f));
    }
    ...
    private void DrawListOfQuads()
    {
        ...
        //GL.Vertex3(0f, 200.0f, 0);

        //GL.TexCoord2(1.0f, 1.0f);
        //GL.Vertex3(200.0f, 200f, 0);
    ...
    {
        //m_DrawDebugTextManager.
    }


    public float x = 164.352f;
    public float y = 88.44798f;
    public float width = 34.47466f;
    public float height = 44.22399f;
...
public class DrawDebugLetter
{
    ...
    public DrawDebugLetter(float InX, float InY, float InW, float InH)
    {
        X = InX;
        Y = InY;
        W = InW;
...
public class DrawDebugText
{
    public string                   m_TextString;
    public List<DrawDebugLetter>    m_TextLettersList;
    public TextAnchor               m_TextAnchor;
    public Vector3                  m_TextPosition;
    public float                    m_RemainLifeTime;

    public DrawDebugText()
    {
        m_TextLettersList = new List<DrawDebugLetter>();
    }

    public DrawDebugText(string TextString, TextAnchor TextAnchor, Vector3 TextPosition, float LifeTime)
    {
...
public class DrawDebugTextManager
{
    public List<DrawDebugText> TextesList;

    

    public DrawDebugTextManager()
    {
        TextesList = new List<DrawDebugText>();

        XmlSerializer s = new XmlSerializer(typeof(DrawDebugLetter));
        DrawDebugLetter l = (DrawDebugLetter)s.Deserialize(new StringReader(TextDatas.DebugTextFontXml));
    }

    public void AddNewText(DrawDebugText Text)
    {
        TextesList.Add(Text);
    }
    private DrawDebugLetter GetLetterInfos(string Letter)
    {
        DrawDebugLetter LetterInfos = new DrawDebugLetter();
...
public static class TextDatas
{
    public static Texture2D GetFontTexture()
    {
        ...
        Texture2D FontTexture = new Texture2D(1024, 1024);
    ...
    public static string DebugTextFontXml = @"
